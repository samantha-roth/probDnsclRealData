...
for(f in 1:length(flood)){
  ...
  load(paste0("probDnsclRealData/data/",flood[f],"/sourcesForDests10mto5m.RData"))
  ...
  save(sourceCoordsForDests10m,sourceIndsForDests10m,
       ...
       file=paste0("probDnsclRealData/data/",flood[f],"/sourceIndsCoordsForDests10mto5m.RData"))
  
  ptFinal<-proc.time()-pt
  time_sourcesForDests<-ptFinal[3]
  save(time_sourcesForDests, file= paste0("C:/Users/svr5482/probDnsclRealData/data/",flood[f],"/time_sourcesForDests10mto5m.RData"))
