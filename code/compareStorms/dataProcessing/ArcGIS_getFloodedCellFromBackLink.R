...
for(f in 1:length(flood)){
  ...
  backlink10mat5m<- rast(paste0("Documents/ArcGIS/Projects/ProbDnsclRealDataOtherFloods/BackLink_",flood[f],".tif"))
  ...
  save(sourcesForDests10m,total,file=paste0("probDnsclRealData/data/",flood[f],"/sourcesForDests10mto5m.RData"))
  
  ptFinal<-proc.time()-pt
  time_backLink_FloodArea<-ptFinal[3]
  save(time_backLink_FloodArea, file= paste0("C:/Users/svr5482/probDnsclRealData/data/",flood[f],"/time_backLink_FloodArea_10mto5m.RData"))
