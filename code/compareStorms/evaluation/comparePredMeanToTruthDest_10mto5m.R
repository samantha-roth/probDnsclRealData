...
for(f in 1:length(flow)){
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/shiftbyelevdnsclMeanAtDests_10mto5m.RData"))
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/shiftbyelevdnsclCDFmat_10mto5m.RData"))
...
#[1] "Q2559.8429"
#[1] "MAE: 0.0225277588033866"
#[1] "% in bounds: 0.99758337361044"
#[1] "Q2503.2092"
#[1] "MAE: 0.0221792224279532"
#[1] "% in bounds: 0.997228637413395"
#[1] "Q3681.19006"
#[1] "MAE: 0.0352981210341704"
#[1] "% in bounds: 1"