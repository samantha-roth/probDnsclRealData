...
for(f in 1:length(flood)){
  ...
  load(paste0("probDnsclRealData/data/",flood[f],"/bdsdownscale10mto5mAroundHWMs.RData"))
  
  #load flooded locations at the two lower resolutions being downscaled
  load(paste0("probDnsclRealData/data/",flood[f],"/floodInds10mat5mAroundHWMs.RData"))
  ...
  load(paste0("probDnsclRealData/data/",flood[f],"/vals5minBdsAroundHWMs.RData"))
  ...
  load(paste0("probDnsclRealData/data/",flood[f],"/downscale10mto5mAroundHWMs.RData"))
  ...
  load(paste0("probDnsclRealData/data/",flood[f],"/shiftbyelevdnsclMeanAtDests_10mto5mElev.RData"))
  ...
  load(paste0("probDnsclRealData/data/",flood[f],"/shiftbyelevdnsclCDFmat_10mto5mElev.RData"))
