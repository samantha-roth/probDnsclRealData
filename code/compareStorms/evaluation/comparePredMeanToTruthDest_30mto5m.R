...
for(f in 1:length(flow)){
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/shiftbyelevdnsclMeanAtDests_30mto5m.RData"))
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/shiftbyelevdnsclCDFmat_30mto5m.RData"))
...
#[1] "Q2559.8429"
#[1] "MAE: 0.0924846337106421"
#[1] "% in bounds: 0.993071593533487"
#[1] "Q2503.2092"
#[1] "MAE: 0.0878173018716218"
#[1] "% in bounds: 0.995297135528003"
#[1] "Q3681.19006"
#[1] "MAE: 0.162411357404706"
#[1] "% in bounds: 0.957467853610287"
