...
for(f in 1:length(flow)){
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/bdsdownscale50mto5mAroundRS20.RData"))
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/shiftbyelevdnsclMeanAtDests_50mto5mElev.RData"))
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/shiftbyelevdnsclCDFmat_50mto5mElev.RData"))
...
# "Q2559.8429"
# "95% Prediction Interval Coverage: 0.995614035087719"
# "MAE: 0.191885463583093"
# "Q2503.2092"
# "95% Prediction Interval Coverage: 0.99780701754386"
# "MAE: 0.180223016140147"
# "Q3681.19006"
# "95% Prediction Interval Coverage: 0.953947368421053"
# "MAE: 0.278229262392643"