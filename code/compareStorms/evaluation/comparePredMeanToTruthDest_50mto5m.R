...
for(f in 1:length(flow)){
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/shiftbyelevdnsclMeanAtDests_50mto5m.RData"))
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/shiftbyelevdnsclCDFmat_50mto5m.RData"))
...
#[1] "Q2559.8429"
#[1] "MAE: 0.200133528264436"
#[1] "% in bounds: 0.969218307006885"
#[1] "Q2503.2092"
#[1] "MAE: 0.181845381663847"
#[1] "% in bounds: 0.96551724137931"
#[1] "Q3681.19006"
#[1] "MAE: 0.227147952437238"
#[1] "% in bounds: 1"