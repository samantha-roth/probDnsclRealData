...
for(f in 1:length(flood)){
  ...
  save(time_estProbFloodIndsofInterest, 
       file= paste0("probDnsclRealData/data/",flood[f],"/time_estProbFloodIndsofInterest_10mto5mElev.RData"))
  ...
  #downscaled and shifted by elevation:
  #0.4884615 of 1 wet destination cells were identified as 
  ...
  save(indsProbNotFloodgeq.5,indsProbFloodgeq.5,
       ...
       file=paste0("probDnsclRealData/data/",flood[f],"/estProbFloodIndsofInterest_10mto5mElev.RData"))
  
  ################################################################################
  pFloodDry<- 1-totProbleq0
  save(pFloodDry,file=paste0("probDnsclRealData/data/",flood[f],"/pFloodDry_10mto5mElev.RData"))
  
}

# "flood2014"
# "specificity: 0.997334754797441"
# "sensitivity: 0.368831168831169"
# "total accuracy: 0.966662441374065"
# "flood2020"
