...
for(f in 1:length(flood)){
  ...
  save(time_estProbFloodIndsofInterest, 
       file= paste0("probDnsclRealData/data/",flood[f],"/time_estProbFlood.3mIndsofInterest_10mto5mElev.RData"))
  ...
  save(indsProbNotFloodgeq.5,indsProbFloodgeq.5,
       ...
       file=paste0("probDnsclRealData/data/",flood[f],"/estProb.3mFloodIndsofInterest_10mto5mElev.RData"))
  
  ################################################################################
  pFloodDry<- 1-totProbleq.3
  save(pFloodDry,file=paste0("probDnsclRealData/data/",flood[f],"/p.3mFloodDry_10mto5mElev.RData"))
