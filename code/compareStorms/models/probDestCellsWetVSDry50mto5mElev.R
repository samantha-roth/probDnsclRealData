...
for(f in 1:length(flow)){
  ...
  save(time_estProbFloodIndsofInterest, 
       file= paste0("probabilisticDownscaling/data/",flow[f],"/simObs/time_estProbFloodIndsofInterest_50mto5mElev.RData"))
  ...
  #downscaled and shifted by elevation:
  #0.4884615 out of 1 of wet destination cells were identified as 
  ...
  save(indsProbNotFloodgeq.5,indsProbFloodgeq.5,
       ...
       file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/estProbFloodIndsofInterest_50mto5mElev.RData"))
  
  ################################################################################
  pFloodDry<- 1-totProbleq0
  save(pFloodDry,file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/pFloodDry_50mto5mElev.RData"))
  
}

# "Q2559.8429"
# "specificity: 0.971837944664032"
# "sensitivity: 0.658426966292135"
# "total accuracy: 0.915350344268935"
# "Q2503.2092"
# "specificity: 0.984330484330484"
# "sensitivity: 0.60431654676259"
# "total accuracy: 0.921521997621879"
# "Q3681.19006"
# "specificity: 0.988801791713326"
# "sensitivity: 0.562770562770563"
# "total accuracy: 0.901245551601424"
