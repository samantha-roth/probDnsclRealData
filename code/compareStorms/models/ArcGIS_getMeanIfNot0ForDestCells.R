...
for(f in 1:length(flood)){
  ...
  load(paste0("probDnsclRealData/data/",flood[f],"/destInds10mat5m.RData")) #destInds10m
  ...
  load(paste0("probDnsclRealData/data/",flood[f],"/WSE.dnsclAtSource10mto5m.RData"))
  ...
  save(meanFromSourceToDest,file=paste0("probDnsclRealData/data/",flood[f],"/shiftbyelevdnsclFromSourceToDest10mto5m.RData"))
  ...
  #}
  #save(meanFromSourceToDest,file="probDnsclRealData/data/dnsclFromSourceToDest10mto5m.RData")
  
  
  ptFinal<-proc.time()-pt
  time_meanIfNot0<-ptFinal[3]
  save(time_meanIfNot0, file= paste0("C:/Users/svr5482/probDnsclRealData/data/",flood[f],"/time_meanIfNot0_10mto5m.RData"))
