...
for(f in 1:length(flow)){
  ...
  backlink10mat5m<- rast(paste0("Documents/ArcGIS/Projects/Storm",flow[f],"/BackLink_10mat5m.tif"))
  ...
  save(sourcesForDests10m,total,file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/sourcesForDests10mto5m.RData"))
  
  ptFinal<-proc.time()-pt
  time_backLink_FloodArea<-ptFinal[3]
  save(time_backLink_FloodArea, file= paste0("C:/Users/svr5482/probabilisticDownscaling/data/",flow[f],"/time_backLink_FloodArea_10mto5m.RData"))
