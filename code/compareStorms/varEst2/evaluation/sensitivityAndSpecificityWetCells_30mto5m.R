...
for(f in 1:length(flow)){
  ...
  pNoFlood<- rep(NA, length(downscale30m))
  for(i in 1:length(downscale30m)){
    pNoFlood[i]<- pnorm(0, mean= downscale30m[i], sd = sqrt(predVD30mto5m))
  }
  
  noFlood5mInds<- which(floodvals5mby30m==0)
  ...
  flood5mInds<- which(floodvals5mby30m>0)
  ...
  save(spec_LRW,sens_LRW,nFlood,nNoFlood,flood5mInds,noFlood5mInds,
       ...
       file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/wetCellAccuracy30mto5m.RData"))
  
  pFloodWet<- 1-pNoFlood
  save(pFloodWet,file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/pFloodWet_30mto5m.RData"))
  
}

#[1] "Q2559.8429"
#[1] "specificity: 0.643478260869565"
#[1] "sensitivity: 0.942982456140351"
#[1] "Q2503.2092"
#[1] "specificity: 0.684210526315789"
#[1] "sensitivity: 0.953226761397276"
#[1] "Q3681.19006"
#[1] "specificity: 1"
#[1] "sensitivity: 0.955642530984997"
