...
for(f in 1:length(flow)){
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/bdsdownscale30mto5mAroundRS20.RData"))
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/shiftbyelevdnsclMeanAtDests_30mto5m.RData"))
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/shiftbyelevdnsclCDFmat_30mto5m.RData"))
...
# "Q2559.8429"
# "95% Prediction Interval Coverage: 0.964181286549708"
# "MAE: 0.150115756203195"
# "Q2503.2092"
# "95% Prediction Interval Coverage: 0.969785575048733"
# "MAE: 0.140323690214829"
# "Q3681.19006"
# "95% Prediction Interval Coverage: 0.967348927875244"
# "MAE: 0.301837383109631"