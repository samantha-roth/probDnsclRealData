...
for(f in 1:length(flow)){
  ...
  WSE.dnscl<- test
  save(WSE.dnscl,file=paste0("probabilisticDownscaling/data/",flow[f],"/WSE.dnsclAtSource10mto5m.RData"))
  ...
  save(downscale10m, file= paste0("probabilisticDownscaling/data/",flow[f],"/simObs/downscale10mto5mAtSource.RData"))
  ...
  save(time_downscale10mAtSource, file= paste0("probabilisticDownscaling/data/",flow[f],"/simObs/time_downscale10mto5mAtSource.RData"))
  ...
  save(val.10mAdjAtSource,file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/val.10mto5mAdjAtSource.RData"))
