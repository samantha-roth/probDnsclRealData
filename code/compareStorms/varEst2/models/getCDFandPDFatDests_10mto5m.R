...
for(f in 1:length(flow)){
  ...
  CDFatDestPt<- function(sigma, i, num){
    probleqNumGivenNotPtMass<- pnorm(num, mean = meanFromSourceToDest[i], sd = sqrt(predVD10mto5m))
  ...
  save(CDFmat,file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/shiftbyelevdnsclCDFmat_10mto5m.RData"))
  ...
  save(approxPDFmat,file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/shiftbyelevdnsclApproxPDFmat_10mto5m.RData"))
  ...
  save(meanAtDests,file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/shiftbyelevdnsclMeanAtDests_10mto5m.RData"))
  
  ptFinal<-proc.time()-pt
  time_getCDFandPDFatDests<-ptFinal[3]
  save(time_getCDFandPDFatDests, file=paste0("C:/Users/svr5482/probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/time_getCDFandPDFatDests_10mto5m.RData"))
