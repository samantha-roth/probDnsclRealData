...
for(f in 1:length(flow)){
  ...
  load(paste0("probabilisticDownscaling/data/",flow[f],"/simObs/modelProbFloodbyCost/predProbFloodatDest_5mCost30mModel.RData"))
  ...
  for(i in 1:length(meanFromSourceToDest)){
    probleq0GivenNotPtMass[i]<- pnorm(0, mean = meanFromSourceToDest[i], sd = sqrt(predVD30mto5m))
  ...
  save(time_estProbFloodIndsofInterest, 
       file= paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/time_estProbFloodIndsofInterest_30mto5m.RData"))
  ...
  #downscaled
  #68.31442% (5m costs) (67.66613% 30m costs)of dry destination cells were identified as 
  ...
  #downscaled
  #fit= 0.6300448 (5m costs) 0.625 (30m costs)
  ...
  #downscaled:
  #60% (5m costs) (60.76923% 30m costs)of wet destination cells were identified as 
  ...
  #downscaled
  #fit= 0.2396313 (5m costs) (0.2397572 30m costs)
  #downscaled and shifted by elevation
  ...
  save(indsProbNotFloodgeq.5,indsProbFloodgeq.5,
       ...
       file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/estProbFloodIndsofInterest_30mto5m.RData"))
  
  ################################################################################
  pFloodDry<- 1-totProbleq0
  save(pFloodDry,file=paste0("probabilisticDownscaling/data/",flow[f],"/simObs/interpVarDnsclErrbyMeanAbsElevDiff/pFloodDry_30mto5m.RData"))
  
}

#[1] "Q2559.8429"
#[1] "specificity: 0.985786802030457"
#[1] "sensitivity: 0.276923076923077"
#[1] "total accuracy: 0.921939953810624"
#[1] "Q2503.2092"
#[1] "specificity: 0.992836676217765"
#[1] "sensitivity: 0.318367346938775"
#[1] "total accuracy: 0.922188969645148"
#[1] "Q3681.19006"
#[1] "specificity: 1"
#[1] "sensitivity: 0.188034188034188"
#[1] "total accuracy: 0.906033630069238"
