...
for(v in 1: length(var_samples)){
  ...
  save(CDFmat,file=paste0("data/var_sample",v,"/shiftbyelevdnsclCDFmat_10mto5mElev_QGIS.RData"))
  ...
  save(approxPDFmat,file=paste0("data/var_sample",v,"/shiftbyelevdnsclApproxPDFmat_10mto5mElev_QGIS.RData"))
  ...
  save(meanAtDests,file=paste0("data/var_sample",v,"/shiftbyelevdnsclMeanAtDests_10mto5mElev_QGIS.RData"))
