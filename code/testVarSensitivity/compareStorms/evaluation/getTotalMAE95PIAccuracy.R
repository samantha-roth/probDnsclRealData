...
for(f in 1:length(flood)){
  ...
  for(v in 1: length(var_samples)){
    ...
    load(paste0("data/",flood[f],"/var_sample",v,"/bdsdownscale10mto5mAroundHWMs.RData"))
    ...
    load(paste0("data/",flood[f],"/var_sample",v,"/shiftbyelevdnsclMeanAtDests_10mto5mElev_QGIS.RData"))
    ...
    load(paste0("data/",flood[f],"/var_sample",v,"/shiftbyelevdnsclCDFmat_10mto5mElev_QGIS.RData"))
