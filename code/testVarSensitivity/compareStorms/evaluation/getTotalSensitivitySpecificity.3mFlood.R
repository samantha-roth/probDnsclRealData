...
for(f in 1:length(flood)){
  ...
  for(v in 1: length(var_samples)){
    ...
    load(paste0("data/",flood[f],"/var_sample",v,"/wetCellAccuracy_.3mflood_10mto5m.RData"))
    ...
    load(paste0("data/",flood[f],"/var_sample",v,"/estProb.3mFloodIndsofInterest_10mto5mElev_QGIS.RData"))
