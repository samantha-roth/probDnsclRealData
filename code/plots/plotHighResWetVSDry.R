...
df<- data.frame("flood"= HighResFlood,
...
filename<- "probDnsclRealData/plots/HighResFlood_5m.jpeg"
...
#now define flooded as flood height >.3m
df<- data.frame("flood"= HighResFlood.3m,
                "latitude"= lonlat_all[,2],
                "longitude"=lonlat_all[,1])
