...
save(downscale10m, file= "data/downscale10mto5mAroundHWMs.RData")
#downscaling improves performance compared to just adjusting here

ptFinal<-proc.time()-pt
time_downscale10mAroundHWMs<-ptFinal[3]
save(time_downscale10mAroundHWMs, file= "data/time_downscale10mAroundHWMs.RData")
...
save(VD10to5, file= "data/VD10to5.RData")
