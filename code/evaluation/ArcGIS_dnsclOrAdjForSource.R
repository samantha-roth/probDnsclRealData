...
WSE.dnscl<- test
save(WSE.dnscl,file="probDnsclRealData/data/WSE.dnsclAtSource10mto5m.RData")
...
save(downscale10m, file= "probDnsclRealData/data/downscale10mto5mAtSource.RData")
...
save(time_downscale10mAtSource, file= "probDnsclRealData/data/time_downscale10mto5mAtSource.RData")
...
save(val.10mAdjAtSource,file="probDnsclRealData/data/val.10mto5mAdjAtSource.RData")
