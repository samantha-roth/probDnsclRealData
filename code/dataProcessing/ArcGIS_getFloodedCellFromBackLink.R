...
backlink10mat5m<- rast("Documents/ArcGIS/Projects/ProbDnsclRealData/BackLink_bin10.tif")
...
save(sourcesForDests10m,total,file="probDnsclRealData/data/sourcesForDests10mto5m.RData")

ptFinal<-proc.time()-pt
time_backLink_FloodArea<-ptFinal[3]
save(time_backLink_FloodArea, file= "C:/Users/svr5482/probDnsclRealData/data/time_backLink_FloodArea_10mto5m.RData")
